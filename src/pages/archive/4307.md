...
```html
<div class="sns03">
  <?php $url = get_permalink(); $_url = urlencode($url); $title =
  the_title('','', false); $_title = urlencode($title); ?>
  <ul style="list-style-type: none">
    <li class="twitter">
      <a
        href="http://twitter.com/intent/tweet?url=<?php echo $_url;?>&text=<?php echo $_title;?>"
        target="_blank"
      >
    ...
    <li class="hatena">
      <a
        onclick="window.open('http://b.hatena.ne.jp/add?mode=confirm&url=<?php echo $_url;?>&t=<?php echo $_title;?>', '', 'width=500,height=400'); return false"
        href="http://b.hatena.ne.jp/add?mode=confirm&url=<?php echo $_url;?>&t=<?php echo $_title;?>"
        target="_blank"
      >
        <img src="はてブの画像URL" />
      </a>
    ...
    <li class="facebook">
      <a
        onclick="window.open('http://www.facebook.com/sharer.php?src=bm&u=<?php echo $_url;?>&t=<?php echo $_title;?>', '', 'width=500,height=400'); return false"
        href="http://www.facebook.com/sharer.php?src=bm&u=<?php echo $_url;?>&t=<?php echo $_title;?>"
        target="_blank"
      >
...
```html
<a href="https://twitter.com/intent/user?screen_name=ユーザーID">
